...
finalloc='D:/ThesisExperiments/OriginalData/ResultsB previous/ResultsB/'
    ...
    for l in np.arange(len(Lay)):
        for n in np.arange(len(NodnoCEA)):
            for ar in np.arange(len(AR)):
                ...
                file0="AR"+str(AR[ar])+"Pred"+str(Lay[l])+sets[0]+"Hour"+str(Hour[h])+"Nod"+str(NodnoCEA[n]+AR[ar])+"Opti"+str(CEA[0])+"gr9"
                ...
                for c in np.arange(10):    
                    ...
                    title0='Train performance for Model HourForec:'+str(Hour[h])+' Layer:'+str(Lay[l])+" Nodes:"+str(NodnoCEA[n])+" AR:"+str(AR[ar])+" NO CEA"
                    plt.title("\n".join(tw.wrap(title0,45)),fontsize=15)
                    plt.ylabel('Energy (scaled)',fontsize=15)
                    plt.xlabel('Hours',fontsize=15)
                    plt.legend(loc='lower right',prop={'size': 10})
                    plt.tight_layout()
                    fig0.savefig(finalloc+'/Plots thesis/'+file0+"red"+str(c)+'.png')
                    plt.close()
                    ...
                    plt.grid(True)
                    #plt.title("\n".join(tw.wrap(text='Loss evolution for Model HourForec:'+str(Hour[h])+' Layer:'+str(Lay[l])+" Nodes:"+str(NodnoCEA[n])+" AR:"+str(AR[ar])+" NO CEA")),fontsize=15)
                    title0='Train performance for Model HourForec:'+str(Hour[h])+' Layer:'+str(Lay[l])+" Nodes:"+str(NodnoCEA[n])+" AR:"+str(AR[ar])+" CEA:Yes"
                    plt.title("\n".join(tw.wrap(title0,45)),fontsize=15)
                    plt.ylabel('Energy (scaled)',fontsize=15)
                    plt.xlabel('Hours',fontsize=15)
                    plt.legend(loc='lower right',prop={'size': 10})
                    plt.tight_layout()
                    fig1.savefig(finalloc+'/Plots thesis/'+file1+"red"+str(c)+'.png')
                    plt.close()
                    ...
                    plt.grid(True)
                    #plt.title("\n".join(tw.wrap(text='Loss evolution for Model HourForec:'+str(Hour[h])+' Layer:'+str(Lay[l])+" Nodes:"+str(NodnoCEA[n])+" AR:"+str(AR[ar])+" NO CEA")),fontsize=15)
                    title0='Test performance for Model HourForec:'+str(Hour[h])+' Layer:'+str(Lay[l])+" Nodes:"+str(NodnoCEA[n])+" AR:"+str(AR[ar])+" NO CEA"
                    plt.title("\n".join(tw.wrap(title0,45)),fontsize=15)
                    plt.ylabel('Energy (scaled)',fontsize=15)
                    plt.xlabel('Hours',fontsize=15)
                    plt.legend(loc='lower right',prop={'size': 10})
                    plt.tight_layout()
                    fig2.savefig(finalloc+'/Plots thesis/'+file2+"red"+str(c)+'.png')
                    plt.close()
                    ...
                    plt.legend(loc='lower right',prop={'size': 10})
                    plt.tight_layout()
                    fig3.savefig(finalloc+'/Plots thesis/'+file3+"red"+str(c)+'.png')
                    plt.close()
    ...
    for l in np.arange(len(Lay)):
        for n in np.arange(len(NodnoCEA)):
            for ar in np.arange(len(AR)):
                ...
                #print("Hour "+str(Hour[h])+" Layer "+str(Lay[l])+" Nodes "+str(NodnoCEA[n])+" AR "+str(AR[ar]))
                #print("Hour "+str(Hour[h])+" Layer "+str(Lay[l])+" Nodes "+str(NodsiCEA[n])+" AR "+str(AR[ar]))
                file0="AR"+str(AR[ar])+"Loses"+str(Lay[l])+"Hour"+str(Hour[h])+"Nod"+str(NodnoCEA[n]+AR[ar])+"Opti"+str(CEA[0])+"gr9"
                file1="AR"+str(AR[ar])+"Loses"+str(Lay[l])+"Hour"+str(Hour[h])+"Nod"+str(NodsiCEA[n]+AR[ar])+"Opti"+str(CEA[1])+"gr9"
                #print(file0)
                ...
                plt.legend(loc='lower right',prop={'size': 10})
                plt.tight_layout()
                fig0.savefig(finalloc+'/Plots thesis/Loses NARX/'+file0+'.png')
                plt.close()
                ...
                plt.legend(loc='lower right',prop={'size': 10})
                plt.tight_layout()
                fig1.savefig(finalloc+'/Plots thesis/Loses NARX/'+file1+'.png')
                plt.close()
